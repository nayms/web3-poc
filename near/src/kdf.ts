...
export const uncompressedHexPointToEvmAddress = (uncompressedHexPoint: string) => {
...
export const uncompressedHexPointToBtcAddress = async (publicKeyHex: string, network: string) => {
